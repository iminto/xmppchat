package com.bai.front.constant;
...
public final class Constant {
    ...
    public static Set<String>         TENDER_SET             = Collections.synchronizedSet(new HashSet<String>());

    public static Map<String, String> RESULT_MAP             = Collections
                                                                     .synchronizedMap(new HashMap<String, String>());

    /** 网站域名根目录，物理路径 */
    // public static final String WEBROOT_PATH = "";

    /** 网站域名根目录 */
    public static final String        BASE_URL               = PropUtil.get("webapp.url");
