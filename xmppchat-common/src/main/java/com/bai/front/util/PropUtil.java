package com.bai.front.util;

import java.util.*;

import com.bai.front.constant.Constant;
import com.bai.front.kit.Prop;
import com.bai.front.kit.PropKit;
...
public class PropUtil {
    ...
    public Properties loadProp(final String pro, final String dev) {
        try {
            return loadPropertyFile(pro, Constant.DEFAULT_CHARSET);
        } catch (final Exception e) {
            return loadPropertyFile(dev, Constant.DEFAULT_CHARSET);
        }
    }
